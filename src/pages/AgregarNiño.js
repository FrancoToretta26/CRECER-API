    ...
    import Icono from "../img/iconoChicos.png";
...
import { getHijosByMail } from "../controller/hijo.controller";
    ...
    export default function AgregarHijo(props) {
      ...
      const [pesoDropdown, setpesoDropdown] = React.useState('');
  ...
  const [generoDropdown, setgeneroDropdown] = React.useState('');
  const [edadDropdown, setedadDropdown] = React.useState('');

  const handleChangeEdad = (event) => {
    setedadDropdown(event.target.value);
    };

const handleChangeGenero = (event) => {
setgeneroDropdown(event.target.value);
};
...
const [diametroDropdown, setdiametroDropdown] = React.useState('');

const handleChangeDiametro = (event) => {
setdiametroDropdown(event.target.value);
};
...
const [sangreDropdown, setsangreDropdown] = React.useState('');

const handleChangeSangre = (event) => {
setsangreDropdown(event.target.value);
};
            ...
            <Typography component="h1" variant="h5">
              ...
              <TextField
                ...
                <TextField
                  ...
                  inputProps={{
                    type: "genero",
                    onChange: (event) => handleGenero(event),
                  }}
                  >
                  {generos.map((option) => (
                ...
                <TextField
                  ...
                  inputProps={{
                    type: "edad",
                    onChange: (event) => handleEdad(event),
                  }}
                  >
                  {edades.map((option) => (
                  <MenuItem key={option.value} value={option.value}>
                ...
                <TextField
                  ...
                  type="diametroCabeza"
                  name="diametroCabeza"
                  value={diametroDropdown}
                  onChange={handleChangeDiametro}
                  formControlProps={{
                    fullWidth: true
                  }}
                  inputProps={{
                ...
                <TextField
                  ...
                  inputProps={{
                    type: "grupoSanguineo",
                    onChange: (event) => handlegrupoSanguineo(event),
                  }}
                  >
                  {sangre.map((option) => (
                  <MenuItem key={option.value} value={option.value}>
                  ...
                  inputProps={{
                    type: "alergias",
                    onChange: (event) => handleAlergias(event),
                  }}
                />
                                <TextField
                  variant="outlined"
                  ...
                  inputProps={{
                    type: "enfermedades",
                    onChange: (event) => handleEnfermedades(event),
                  }}
                />
