...
class AddEventModal extends Component {
  ...
  submitForm = e => {
    e.preventDefault();
    const { date, id, title, description, time, diametro, medicamentos, dosis, periodo, peso, altura, hijos, estudios, resultados } = this.state.eventToEdit
    console.log({ date, id, title, description, diametro, medicamentos, dosis, time, periodo, peso, altura, hijos, estudios, resultados })
  ...
  render() {
    ...
    const { title, description, time, diametro, medicamentos, dosis, periodo, peso, altura,hijos, resultados, estudios, date } = this.state.eventToEdit;
          ...
          <div className="paper add-event-modal">
            ...
            <div>
                <TextField
                  ...
                  fullWidth
                  select
                  onChange={e => this.setHijos(e.target.value)}
                >
            ...
            <div>
              ...
              <div>
                <TextField
                  ...
                  defaultValue={diametro}
                  variant="outlined"
                  margin="normal"
                  fullWidth
                  select
                  onChange={e => this.setDiametro(e.target.value)}
                >
              ...
              <div>
                <TextField
                  ...
                  margin="normal"
                  fullWidth
                  onChange={e => this.setMedicamentos(e.target.value)}
                />
              </div>
              <div>
                <TextField
