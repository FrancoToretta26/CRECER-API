...
class AddEventModal extends Component {
  ...
  render() {
    ...
    const botonazo = function(){
      enviarDatos()
      }
      
  

    const { title, description, time, diametroCabeza, medicamento, dosis, periodo, peso, altura,name, resultados, estudios, date } = this.state.eventToEdit;
    ...
    const enviarDatos= async function()
    {
        ...
        let getRegistro = await addVisita(datos)
      }
